...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='label2cell', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='../dataset/testSet_resize')
        self.parser.add_argument('--train_file_list', type = str,default='../dataset/splittrain.txt')
        self.parser.add_argument('--val_file_list',type=str,default='../dataset/splitval.txt')
        self.parser.add_argument('--test_file_list', type=str, default='../dataset/test.txt')
        ...
        self.parser.add_argument('--ndf', type=int, default=64, help='# of gen filters in first conv layer')
        ...
        self.parser.add_argument('--n_global_enhancers', type=int, default=1, help='number of local enhancers to use')
        self.parser.add_argument('--niter_fix_local', type=int, default=0, help='number of epochs that we only train the outmost local enhancer')
        #
